    ...
    <div className="flex flex-wrap justify-between">
      {previous && (
        <div className="w-full p-2 lg:w-1/2">
          <Link className="inline-flex items-center flex-1 button bg-purple-darker" to={previous.fields.slug} rel="prev">
      ...
      {next && (
        <div className="w-full p-2 lg:w-1/2">
          <Link className="inline-flex items-center flex-1 button bg-purple-darker" to={next.fields.slug} rel="next">
    ...
    return (
      <Layout location={this.props.location}>
        ...
        <article className="blog-post">
          <h1 className="mb-0 text-3xl">{post.frontmatter.title}</h1>
          <p className="mt-0 mb-8 text-sm frontmatter">
            <span>
